      ...
      <section id="portfolio" className="w-full max-w-7xl mx-auto py-32 px-6">
        ...
        <div className="flex flex-col">
          {projects.map((project) => (
            <div
              key={project.id}
              className="group border-t border-white/20 py-12 flex flex-col md:flex-row justify-between items-start md:items-center transition-colors hover:bg-white/5"
            >
              ...
              <p className="mt-4 md:mt-0 max-w-md text-white/60 group-hover:text-white transition-colors">
                {project.description}
              </p>
            </div>
          ))}
